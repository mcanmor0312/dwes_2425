  ...
  <div class="container">
    ...
    <form method="GET">
      ...
      <div class="btn-group" role="group">
        ...
        <button type="submit" class="btn btn-danger" formaction="restar.php">Restar</button>
        <button type="submit" class="btn btn-dark" formaction="multiplicar.php">Multiplicar</button>
        <button type="submit" class="btn btn-Success" formaction="division.php">Dividir</button>
      </div>
